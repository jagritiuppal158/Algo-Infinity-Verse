...
function runSimulation() {
    ...
    routes.forEach(route => {
        ...
        block.innerHTML = \`
            <div class="swagger-header" onclick="toggleSwaggerBlock('\${route.id}')">
            ...
            <div class="swagger-body" id="\${route.id}-body">
                <button class="swagger-btn-try" onclick="enableExecute('\${route.id}')">Try it out</button>
                <div style="clear:both;"></div>
                
                <div id="\${route.id}-execute-container" style="display:none;">
                    <button class="swagger-btn-execute" onclick="executeSwaggerRoute('\${route.method}', '\${route.path}', '\${route.id}')">Execute</button>
                </div>

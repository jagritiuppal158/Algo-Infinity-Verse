...
let userProgress = JSON.parse(localStorage.getItem('elasticHubProgress')) || { completedLessons: [], completedQuizzes: [] };

// Mock Elasticsearch Database
const mockDb = {
    products: [
        { id: "1", name: "Dell XPS 13 Laptop", category: "electronics", price: 999.99, tags: ["laptop", "computer", "dell"] },
        { id: "2", name: "Apple MacBook Pro", category: "electronics", price: 1299.00, tags: ["laptop", "apple", "mac"] },
        { id: "3", name: "Logitech MX Master 3", category: "accessories", price: 99.99, tags: ["mouse", "wireless"] },
        { id: "4", name: "Sony WH-1000XM4 Headphones", category: "audio", price: 348.00, tags: ["headphones", "wireless", "noise-canceling"] },
        { id: "5", name: "LG 27 inch 4K Monitor", category: "electronics", price: 399.00, tags: ["monitor", "4k", "display"] }
    ]
};
    ...
    "term": {
      "category": "audio"
        ...
        quiz: [
            {
                id: 'q2',
                question: 'Which query type is best used for exact value matching (like IDs or categories)?',
        ...
        quiz: [
            {
                ...
                options: ['To delete the index', 'To return 0 aggregations', 'To skip returning the actual documents and only return the aggregation results', 'To compress the response'],
                correct: 2
            }
        ]
    }
...
function renderQuiz(mIndex) {
    ...
    quiz.forEach((q, i) => {
        ...
        html += \`
                ...
                <button onclick="checkAnswer('\${q.id}', \${mIndex}, \${i})" class="mt-4 bg-teal-600 hover:bg-teal-700 text-white px-4 py-2 rounded text-sm font-medium transition-colors">
                    Submit Answer
                </button>

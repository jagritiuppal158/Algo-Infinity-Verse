/**
 * java-learning.js
 * Interactivity for the Java Learning page:
...
function initHeroTyping() {
  const el = document.getElementById("typingTextJava");
  if (!el) return;
...
function initExerciseToggles() {
  document.querySelectorAll(".java-exercise-toggle").forEach((btn) => {
...
function initCopyButtons() {
  document.querySelectorAll(".java-code-copy").forEach((btn) => {
...
function initSidebarSpy() {
  const links = document.querySelectorAll(".java-sidebar-nav a");

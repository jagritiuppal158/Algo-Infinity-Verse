...
function initHeroTyping() {
  const el = document.getElementById("typingTextOs");
  if (!el) return;
...
function initExerciseToggles() {
  document.querySelectorAll(".os-exercise-toggle").forEach((btn) => {
...
function initCopyButtons() {
  document.querySelectorAll(".os-code-copy").forEach((btn) => {
...
function initSidebarSpy() {
  const links = document.querySelectorAll(".os-sidebar-nav a");
  const lessons = document.querySelectorAll(".os-lesson");
...
function initProgressTracker() {
  const STORAGE_KEY = "os-learning-progress";
  const TOTAL_TOPICS = 11;
  const fill = document.getElementById("progressFill");
  const count = document.getElementById("progressCount");
  const bar = document.querySelector(".os-progress-bar");
